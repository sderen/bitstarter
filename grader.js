...
var checkHtmlFile = function(htmlfile, checksfile, isSource) {
    if(isSource) {
...
var getHtmlFile = function(val, val1) {
//    console.log(val);
//    console.log(val1); 
//    return val.split(',');
    return val;
...
if(require.main == module) {
	...
	.option('-u, --url <domain>', 'File path and domain of the index.html', getHtmlFile)
        .parse(process.argv);
